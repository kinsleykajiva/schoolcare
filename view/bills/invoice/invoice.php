...
<div clasS="row clearfix" style="margin-bottom:20px;">
  ...
  <div class="col-lg-2"> 
      <button onclick ="onSaveInvoice()" clasS=" btn btn-mini btn-success btn-round pull-right"> Generate Inv. </button>
  </div>
</div>
<div clasS="row clearfix" style="margin-bottom:20px;">
    <div class="col-lg-4"> 
...
<div clasS="row clearfix" style="margin-bottom:20px;">
    ...
    <div class="col-md-12">
      <table class="table table-bordered table-hover" id="tab_logic">
        ...
        <tbody>
          <tr id='addr0'>
            <td>1</td>
            <td><input type="text" name='product[]'  placeholder='Enter item Name/Description' class="form-control product"/></td>
            <td><input type="number" name='qty[]' placeholder='Enter Qty' class="form-control qty" step="any" min="0"/></td>
            <td><input type="number" name='price[]' placeholder='Enter Unit Price' class="form-control price" step="any" min="0"/></td>
  ...
  <div class="row clearfix">
    <div class="col-md-12" style="margin: 10px;">
      ...
      <button id='delete_row' class="pull-right btn btn-warning btn-mini btn-round "> <i class="ti-minus"></i>Remove</button>
    </div>
  </div>
