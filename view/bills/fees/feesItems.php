	...
	<div class="card-block">
		<form onsubmit="return false;">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="number" step="any"  id="newFeeAmount" class="form-control form-control-normal" placeholder="Fee Amount">
				</div>
			</div>
	...
	<div class="card-block">
		<form onsubmit="return false;">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Fee Amount</label>
				<div class="col-sm-10">
					<input type="number"  id="editFeeAmount" step="any" class="form-control form-control-normal" placeholder="Fee Amount">
				</div>
			</div>
